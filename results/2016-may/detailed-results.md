...
---- | ----------------- | --------- | --------- | --------- | --------- | ------
 ...
 120 | [C94](#closure-94) | 0 AV      |           |           | 0 AV      |      0
...
Patch type: PRECONDITION
```Java
if(!((com.google.javascript.rhino.Node.this.parent!=null) && (-1 < com.google.javascript.rhino.Node.serialVersionUID)))
```
...
[com.google.javascript.rhino.jstype.RecordType:261](https://github.com/google/closure-compiler/blob/159b1a5b37616b87a5c86cebc1dd04e13e212d0f/src//com/google/javascript/rhino/jstype/RecordType.java#L261)
...
Patch type: PRECONDITION
```Java
if((!(fieldName.length() == (sourceName.length()) - (fieldName.length()))) || (com.google.javascript.rhino.jstype.JSTypeRegistry.this.namesToTypes.size() < sourceName.length() + sourceName.length()))
```
...
Execution time: 0:04:20.681000

Grid5000 node: grisou-38.nancy.grid5000.fr
...
Execution time: 0:03:46.201000

Grid5000 node: grisou-35.nancy.grid5000.fr
...
Patch type: CONDITIONAL
```Java
((negativeZero) && ((prev == '-'))) || ((x < 0) && (prev == '-'))
```

Nb Angelic value: 1

Nb analyzed Statement: 77

Execution time: 0:04:48.881000
...
Patch type: PRECONDITION
```Java
if(!(((node2.parent!=null) && (node2.parent!=null)) || (com.google.javascript.rhino.Node.this.parent!=null)))
```
...
Patch type: PRECONDITION
```Java
if(reductions.size() <= reducers.size())
```
...
Nb analyzed Statement: 62

Execution time: 0:05:21.114000
...
Patch type: CONDITIONAL
```Java
error.equals((java.lang.Object) error)
```
...
Execution time: 0:01:55.941000

Grid5000 node: grisou-2.nancy.grid5000.fr
...
Nb analyzed Statement: 13

Execution time: 0:04:00.351000
...
Patch type: PRECONDITION
```Java
if(com.google.javascript.rhino.Node.ATTRIBUTE_FLAG == node2.type)
```
...
[com.google.javascript.jscomp.VarCheck:187](https://github.com/google/closure-compiler/blob/b928dc1e9a92c2a8fce3c19ea15b2d640d64dad0/src//com/google/javascript/jscomp/VarCheck.java#L187)
...
Patch type: CONDITIONAL
```Java
(provided != null) || (!(-1 <= (com.google.javascript.jscomp.ProcessClosurePrimitives.GOOG.length()) - (ns.length()) + com.google.javascript.jscomp.ProcessClosurePrimitives.GOOG.length()))
```
...
Execution time: 0:08:19.834000

Grid5000 node: grimoire-6.nancy.grid5000.fr
...
Patch type: PRECONDITION
```Java
if((com.google.javascript.rhino.Node.SIDE_EFFECTS_FLAGS_MASK <= com.google.javascript.rhino.Node.this.sourcePosition) || (!(com.google.javascript.rhino.Node.this.propListHead!=null)))
```
...
[com.google.javascript.jscomp.type.SemanticReverseAbstractInterpreter:203](https://github.com/google/closure-compiler/blob/011155db2125d9e7e081822b0db8be45bedd8ff5/src//com/google/javascript/jscomp/type/SemanticReverseAbstractInterpreter.java#L203)

Patch type: PRECONDITION
```Java
if(blindScope == blindScope.optimize())
```
...
[com.google.javascript.rhino.Node:1546](https://github.com/google/closure-compiler/blob/066479c61dc2e8444791acd2663f71cbcb476657/src//com/google/javascript/rhino/Node.java#L1546)
...
Execution time: 0:05:39.694000

Grid5000 node: grisou-6.nancy.grid5000.fr

## Patch #97 Nopol 

[com.google.javascript.rhino.Node:1416](https://github.com/google/closure-compiler/blob/e36d7cba04f575196b44aa101dc65daf6bb68de1/src//com/google/javascript/rhino/Node.java#L1416)

Patch type: CONDITIONAL
```Java
((!(node2.sourcePosition <= com.google.javascript.rhino.Node.FLAG_ARGUMENTS_UNMODIFIED)) || (node2.type < com.google.javascript.rhino.Node.EMPTY_BLOCK)) && (diff!=null)
```

Nb Angelic value: 3

Nb analyzed Statement: 370

Execution time: 0:32:59.121000
...
Nb analyzed Statement: 85

Execution time: 0:18:31.502000
...
Patch type: PRECONDITION
```Java
if((org.apache.commons.math.optimization.linear.SimplexTableau.this.numDecisionVariables) != (org.apache.commons.math.optimization.linear.SimplexTableau.this.constraints.size()))
```
...
Patch type: PRECONDITION
```Java
if(transitions.contains((java.lang.Object) this))
```
